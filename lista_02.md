...
variável idade = entrada do usuário
    Se a entrada do usuário for um número menor que 16: 
        imprima a mensagem: 'Não pode votar!'
    Senão se a entrada for um número maior ou igual a 16 e menor que 18: 
        imprima a mensagem: 'Voto facultativo!'
    Senão: 
        imprima a mensagem: 'Voto obrigatório'
______
...
//Calculo tempo
Enquanto (Simulação = true): 
Tempo++
    Se (Tempo = tempoMax): 
     Simulação = false

//Calculo velocidade e distancia
Velocidade = velocidadeInicial + Aceleração * Tempo
distanciaPercorrida = Velocidade * Tempo

//Checagem velocidade e distancia
